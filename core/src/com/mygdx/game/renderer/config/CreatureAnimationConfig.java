...
public class CreatureAnimationConfig {
    ...
    static {
        configs.put("male1", CreatureAnimationConfig.of("male1", 1, 1.8f, 1.8f, 32, 32, 3, 0.1f, textureDirMap(3, 0, 1, 2)));
        ...
        configs.put("skeleton", CreatureAnimationConfig.of("skeleton", 0, 1.8f, 1.8f, 64, 64, 9, 0.05f, textureDirMap(0, 2, 1,
                                                                                                                      3)));
        configs.put("undead_adventurer", CreatureAnimationConfig.of("undead_adventurer", 0, 1.2f, 1.8f, 32, 48, 4, 0.1f,
                                                                    textureDirMap(3, 0, 1, 2)));
        configs.put("black_mage", CreatureAnimationConfig.of("black_mage", 0, 1.5f, 1.5f, 32, 32, 3, 0.1f, textureDirMap(3, 0,
                                                                                                                         1, 2)));

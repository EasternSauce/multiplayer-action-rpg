...
public class InitialStateLoader {
    public void setupInitialState(CoreGame game) {
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(72.00597f, 185.74562f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.skeleton, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.archer, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.wolf, 100),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(120.66566f, 61.488186f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.skeleton, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.archer, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 200),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(107.045654f, 109.50901f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.skeleton, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.archer, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 200)
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(90.433754f, 149.47726f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.skeleton, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.archer, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 100)
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(143.88635f, 144.49992f),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(194.33566f, 161.41022f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.archer, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.wolf, 70),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 40)
            ).collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            7
        );
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(180.13132f, 189.53963f),
            Stream
                .of(new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 100))
                .collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            5
        );
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(194.17567f, 130.81833f),
            Stream
                .of(new AbstractMap.SimpleEntry<>(EnemyTemplate.spider, 100))
                .collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            1
        );
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(188.66309f, 94.52115f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.archer, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 200),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(149.25409f, 59.35056f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.skeleton, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 100)
            ).collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(189.71574f, 50.233543f),
            Stream
                .of(new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 200))
                .collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            1
        );
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(151.91226f, 4.116901f),
            Stream
                .of(new AbstractMap.SimpleEntry<>(EnemyTemplate.sludge, 200))
                .collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            1
        );
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area1"),
            Vector2.of(134.38565f, 33.810173f),
            Stream
                .of(new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 200))
                .collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            5
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(54.546818f, 17.866678f),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(45.149673f, 42.696243f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.wolf, 100)
            ).collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            3
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(77.41629f, 63.43089f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.mage, 100)
            ).collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            5
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(8.524707f, 50.28812f),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(96.41956f, 25.716f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.minos, 150),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 200),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.sludge, 50),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.spider, 100),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(53.30063f, 115.123146f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.minos, 50),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 300),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.spider, 100)
            ).collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)),
            7
        );
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(46.327713f, 152.19821f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.minos, 50),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 50),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 300),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(94.59606f, 141.75322f),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(87.213615f, 186.61588f),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(123.96952f, 176.52777f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.rat, 100),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(164.68907f, 138.92996f),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(186.80959f, 142.67236f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.sludge, 100),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(158.88972f, 184.15317f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.spider, 100),
        ...
        addEnemyRallyPoint(enemyRallyPoints,
            AreaId.of("Area3"),
            Vector2.of(164.75897f, 85.33934f),
            Stream.of(new AbstractMap.SimpleEntry<>(EnemyTemplate.spider, 100),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.minos, 100),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.serpent, 100),
                new AbstractMap.SimpleEntry<>(EnemyTemplate.sludge, 100),
    ...
    private static void addEnemyRallyPoint(Map<EnemyRallyPointId, EnemyRallyPoint> enemyRallyPoints,
                                           AreaId areaId,
                                           Vector2 pos,

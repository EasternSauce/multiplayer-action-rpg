...
public class EmeraldSpin extends Projectile {
  ...
  public static EmeraldSpin of(AbilityParams abilityParams, @SuppressWarnings("unused") CoreGame game) {
    ...
    ability.params = abilityParams.setWidth(0.8f).setHeight(0.8f).setChannelTime(0f).setActiveTime(3f).setStartingRange(0f).setTextureName("green_whirl").setBaseDamage(11f).setChannelAnimationLooping(false).setActiveAnimationLooping(true).setDelayedActionTime(0.001f).setSpeed(30f).setCreaturesAlreadyHit(new ConcurrentSkipListMap<>()).setMaximumRange(22f);

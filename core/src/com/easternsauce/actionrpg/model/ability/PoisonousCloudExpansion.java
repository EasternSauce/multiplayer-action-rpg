...
public class PoisonousCloudExpansion extends Ability {
    @Getter
    private AbilityParams params;

    int currentCloud = 0;

    public static PoisonousCloudExpansion of(AbilityParams abilityParams, @SuppressWarnings("unused") CoreGame game) {
        PoisonousCloudExpansion ability = PoisonousCloudExpansion.of();

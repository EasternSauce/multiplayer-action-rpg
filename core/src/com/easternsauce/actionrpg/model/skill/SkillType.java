...
public enum SkillType {
  SWORD_SLASH("Sword Slash", true, AbilityType.SWORD_SLASH, 0.6f, 20f, 0f), MOB_SWORD_SLASH("Sword Slash (mob only)", true, AbilityType.EMEMY_SWORD_SLASH, 0.6f, 20f, 0f), BOSS_SWORD_SLASH("Sword Slash (boss only)", true, AbilityType.BOSS_ENEMY_SWORD_SLASH, 0.6f, 20f, 0f), FIREBALL("Fireball", true, AbilityType.FIREBALL, 1.5f, 30f, 20f), LIGHTNING("Lightning", true, AbilityType.LIGHTNING_SPARK, 2f, 20f, 26f), CROSSBOW_SHOT("Crossbow Shot", true, AbilityType.CROSSBOW_SHOT, 2f, 25f, 0f), MOB_CROSSBOW_SHOT("Crossbow Shot (mob only)", true, AbilityType.ENEMY_CROSSBOW_SHOT, 2f, 25f, 0f),
  ...
  VOLATILE_BUBBLE("Volatile Bubble", true, AbilityType.VOLATILE_BUBBLE, 1.3f, 15f, 22f), MOB_VOLATILE_BUBBLE("Volatile Bubble (mob only)", true, AbilityType.ENEMY_VOLATILE_BUBBLE, 1.3f, 15f, 22f),
  ...
  BOSS_SWORD_SPIN("Sword Spin (boss only)", true, AbilityType.BOSS_ENEMY_SWORD_SPIN, 4f, 30f, 0f),
  ...
  POISONOUS_MIXTURE("Poisonous Mixture", false, AbilityType.POISONOUS_MIXTURE, 2f, 10f, 35f), MOB_POISONOUS_MIXTURE("Poisonous Mixture (mob only)", false, AbilityType.ENEMY_POISONOUS_MIXTURE, 2f, 10f, 35f),

  PUNCH("Punch", true, AbilityType.PUNCH, 0.4f, 14f, 0f),

  RING_OF_FIRE("Ring of Fire", true, AbilityType.RING_OF_FIRE, 1f, 10f, 13f), MOB_RING_OF_FIRE("Ring of Fire (mob only)", true, AbilityType.ENEMY_RING_OF_FIRE, 1f, 10f, 13f),

...
public enum SkillType {
    SWORD_SLASH(
        "Sword Slash",
        true,
        AbilityType.SWORD_SLASH,
        0.6f,
        20f,
        0f
    ), MOB_SWORD_SLASH(
        "Sword Slash (mob only)",
        true,
    ...
    VOLATILE_BUBBLE(
        "Volatile Bubble",
        true,
        AbilityType.VOLATILE_BUBBLE,
        1.3f,
        15f,
        22f
    ), MOB_VOLATILE_BUBBLE(
        "Volatile Bubble (mob only)",
        true,
    ...
    BOSS_SWORD_SPIN(
        "Sword Spin (boss only)",
        true,
        AbilityType.BOSS_SWORD_SPIN,
        4f,
        30f,
        0f
    ),

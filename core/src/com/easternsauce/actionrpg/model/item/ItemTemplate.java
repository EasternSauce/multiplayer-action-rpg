...
public class ItemTemplate {
    ...
    static {
        List<ItemTemplate> templates = Arrays.asList(
            ...
            ).setWorth(150).setIsEquipable(true).setEquipmentSlotType(EquipmentSlotType.BODY).setArmor(13),
            ItemTemplate.of(
                "ringmailGreaves",
                "Ringmail Greaves",
                "-",
            ...
            ).setWorth(50).setIsEquipable(true).setEquipmentSlotType(EquipmentSlotType.BOOTS).setArmor(7),
            ItemTemplate.of(
                "hideGloves",
                "Hide Gloves",
                "-",
            ...
            ).setWorth(70).setIsEquipable(true).setEquipmentSlotType(EquipmentSlotType.GLOVES).setArmor(5),
            ItemTemplate
                .of(
                    "boomerang",
                    "Boomerang",
            ...
            ).setWorth(300).setIsEquipable(true).setEquipmentSlotType(EquipmentSlotType.SECONDARY_WEAPON),
            ItemTemplate
                .of(
                    "crossbow",
                    "Crossbow",
            ...
            ).setWorth(300).setIsConsumable(true).setIsStackable(true).setIsQualityNonApplicable(true),
            ItemTemplate.of(
                "manaPotion",
                "Mana Potion",
                "-",
        ...
        ItemTemplate.templates = new ConcurrentSkipListMap<>(list.stream().collect(Collectors.toMap(
            ItemTemplate::getId,

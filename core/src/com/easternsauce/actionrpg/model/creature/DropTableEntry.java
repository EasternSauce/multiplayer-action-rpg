...
public class DropTableEntry implements Comparable<DropTableEntry> {
  public static DropTableEntry hideGlovesDrop = DropTableEntry.of(0.1f, ItemTemplate.templates.get("hideGloves"), 0f,
    new ConcurrentSkipListMap<>());
  public static DropTableEntry ringmailGreavesDrop = DropTableEntry.of(0.1f,
    ItemTemplate.templates.get("ringmailGreaves"), 0f, new ConcurrentSkipListMap<>());
  public static DropTableEntry ironSwordDrop = DropTableEntry.of(0.1f, ItemTemplate.templates.get("ironSword"), 0f,
    new ConcurrentSkipListMap<>());
  public static DropTableEntry crossbowDrop = DropTableEntry.of(0.1f, ItemTemplate.templates.get("crossbow"), 0f,
    new ConcurrentSkipListMap<>());
  public static DropTableEntry boomerangDrop = DropTableEntry.of(0.1f, ItemTemplate.templates.get("boomerang"), 0f,
    new ConcurrentSkipListMap<>());
  public static DropTableEntry lifePotionDrop = DropTableEntry.of(0.9f, ItemTemplate.templates.get("lifePotion"), 0f,
    new ConcurrentSkipListMap<>());
  public static DropTableEntry unlikelyLifePotionDrop = DropTableEntry.of(0.2f,
    ItemTemplate.templates.get("lifePotion"), 0f, new ConcurrentSkipListMap<>());
  public static DropTableEntry manaPotionDrop = DropTableEntry.of(0.9f, ItemTemplate.templates.get("manaPotion"), 0f,
    new ConcurrentSkipListMap<>());
  public static DropTableEntry unlikelyManaPotionDrop = DropTableEntry.of(0.2f,
    ItemTemplate.templates.get("manaPotion"), 0f, new ConcurrentSkipListMap<>());
  public static DropTableEntry leatherArmorDrop = DropTableEntry.of(0.1f, ItemTemplate.templates.get("leatherArmor"),
  ...
  public static DropTableEntry bossTierThreeMagicHideGlovesDrop = DropTableEntry.of(0.1f,
    ItemTemplate.templates.get("hideGloves"), 1f, Stream.of(new AbstractMap.SimpleEntry<>(SkillType.EMERALD_SPIN, 80),
        new AbstractMap.SimpleEntry<>(SkillType.POISONOUS_MIXTURE, 80))
      .collect(Collectors.toMap(AbstractMap.SimpleEntry::getKey, AbstractMap.SimpleEntry::getValue)));
  public static DropTableEntry shieldDrop = DropTableEntry.of(0.1f, ItemTemplate.templates.get("woodenShield"), 1f,

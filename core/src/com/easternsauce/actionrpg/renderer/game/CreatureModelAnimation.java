...
public class CreatureModelAnimation {
  ...
  private List<TextureRegion> createFacingTextures(CreatureAnimationConfig animationConfig, TextureRegion runningAnimationTextureRegion) {
  ...
  private List<Animation<TextureRegion>> createRunningAnimations(CreatureAnimationConfig animationConfig, TextureRegion runningAnimationTextureRegion) {

...
public class InventoryWindowActionDecider {
    ...
    static {
        ...
        strategies.addAll(Arrays.asList(inventoryToInventory,
            potionMenuToPotionMenu,
            inventoryToEquipment,
            equipmentToInventory,
            inventoryToPotionMenu,
            potionMenuToInventory,
    ...
    private static InventoryPutOnCursorCancelAction getMoveCancelAction(InventoryWindowState inventoryWindowState,
                                                                        CoreGame game) {
    ...
    private static InventorySwapSlotItemsAction getMoveItemFromInventoryToInventoryAction(InventoryWindowState inventoryWindowState,
                                                                                          CoreGame game) {
    ...
    private static PotionMenuSwapSlotItemsAction getMoveItemFromPotionMenuToPotionMenuAction(InventoryWindowState inventoryWindowState,
                                                                                             CoreGame game) {
    ...
    private static InventoryAndEquipmentSwapSlotItemsAction getMoveItemFromInventoryToEquipmentAction(
    ...
    private static InventoryAndEquipmentSwapSlotItemsAction getMoveItemFromEquipmentToInventoryAction(
        InventoryWindowState inventoryWindowState,
        CoreGame game) {
        return InventoryAndEquipmentSwapSlotItemsAction.of(game.getGameState().getThisClientPlayerId(),
            inventoryWindowState.getInventorySlotClicked(),
    ...
    private static InventoryItemPutOnCursorAction getInventoryItemPutOnCursorAction(InventoryWindowState inventoryWindowState,
                                                                                    CoreGame game) {
    ...
    private static EquipmentItemPutOnCursorAction getEquipmentItemPutOnCursorAction(InventoryWindowState inventoryWindowState,
                                                                                    CoreGame game) {
    ...
    private static PotionMenuItemPutOnCursorAction getPotionMenuItemPutOnCursorAction(InventoryWindowState inventoryWindowState,
                                                                                      CoreGame game) {

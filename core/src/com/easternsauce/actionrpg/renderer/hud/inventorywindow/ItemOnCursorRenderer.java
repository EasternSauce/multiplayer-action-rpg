...
public class ItemOnCursorRenderer {
    ...
    private static void renderInventoryItemBeingMovedOnCursor(float mouseX,
                                                              float mouseY,
    ...
    private static void renderEquipmentItemBeingMovedOnCursor(float mouseX,
                                                              float mouseY,
    ...
    private static void renderPotionMenuItemBeingMovedOnCursor(float mouseX,
                                                               float mouseY,
